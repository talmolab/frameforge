...
from frameforge.sources import make_source
...
def main(serial_number, test_ip):
    ...
    broadcaster = _make_broadcaster(width, height)
    ...
    try:
        while True:
            gray = (frame.array if frame.array.ndim == 2
                    else cv2.cvtColor(frame.array, cv2.COLOR_RGB2GRAY))
